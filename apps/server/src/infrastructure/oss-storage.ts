...
export class OssStorage {
  private client: any;
  constructor(options: { region: string; bucket: string; accessKeyId: string; accessKeySecret: string }) { this.client = new OSS(options); }
  putUrl(key: string) { return this.client.signatureUrl(key, { method: "PUT", expires: 900 }); }
